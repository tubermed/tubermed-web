...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "От консултация до амбулаторен лист за секунди. GDPR-съвместим, данните се съхраняват в ЕС. Лекарят остава автор.",
    images: [
      {
        url: "/brand/og-image.png",
        alt: "TuberMed - ИИ медицински скрайб: от консултация до амбулаторен лист",
      },
    ],
  },
  twitter: {
