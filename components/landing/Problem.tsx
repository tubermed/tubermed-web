      ...
      <Container className="py-20 md:py-28">
        <Reveal>
          <SectionHeading
            ...
            intro="Анамнеза, обективен статус, МКБ-10, терапия. Всичко се въвежда по време на самия преглед, докато пациентът разказва. Знаете го от всеки работен ден. Международни проучвания показват същото: около 35% от времето на лекаря отива за документиране, а времето пред екран и бюро е почти двойно повече от времето с пациента."
          />
        </Reveal>
