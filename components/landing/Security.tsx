...
const POINTS = [
  {
    icon: EuIcon,
    text: 'Аудиото и записите се обработват и съхраняват в ЕС. AI обработката се извършва при доставчик по Договор за обработване на данни (DPA) и стандартни договорни клаузи (SCC); съдържанието не се съхранява и не се използва за обучение на модели.',
  },
  {
    icon: DocIcon,
