...
const POINTS = [
  {
    icon: EuIcon,
    text: 'Аудиото се обработва, но не се запазва. Остава само текстът на транскрипта. Данните се съхраняват в ЕС. Обработката с ИИ се извършва от доставчик по договор за обработване на данни (DPA) и Стандартни договорни клаузи (SCC). Съдържанието не се задържа от доставчика и не се използва за обучение на модели.',
  },
  {
    icon: DocIcon,
    text: 'Договор за защита на данните (DPA) с всеки доставчик.',
  },
  {
    icon: ControlIcon,
    text: 'Вие контролирате какво се записва и какво влиза в готовия лист. Последната дума винаги е Ваша.',
  },
];
