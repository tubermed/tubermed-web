...
const QA = [
  ...
  },
  {
    ...
    a: 'Аудиото и записите се обработват и съхраняват в ЕС. Обработката с ИИ се извършва от доставчик по договор за обработване на данни (DPA) и Стандартни договорни клаузи (SCC); съдържанието не се съхранява и не се използва за обучение на модели.',
  },
  {
