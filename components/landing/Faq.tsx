...
const QA = [
  {
    q: 'Ако ИИ сбърка, а аз подпиша - проблемът мой ли е?',
  ...
  },
  {
    ...
    a: 'Аудиото се обработва, но не се запазва. Остава само текстът на транскрипта. Данните се съхраняват в ЕС. Обработката с ИИ се извършва от доставчик по договор за обработване на данни (DPA) и Стандартни договорни клаузи (SCC). Съдържанието не се задържа от доставчика и не се използва за обучение на модели.',
  },
  {
