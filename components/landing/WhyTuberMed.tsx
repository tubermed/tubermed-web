...
const POINTS = [
  {
    ...
    body: 'Аудиото се обработва, но не се съхранява. Остава само текстът на транскрипта. Данните се съхраняват в ЕС. Обработката с ИИ се извършва от доставчик по договор за обработване на данни (DPA) и Стандартни договорни клаузи (SCC); съдържанието не се съхранява и не се използва за обучение на модели.',
  },
  {
    icon: LangIcon,
