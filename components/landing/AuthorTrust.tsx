      ...
      <Container className="grid items-center gap-12 py-20 md:py-28 lg:grid-cols-2 lg:gap-16">
        <Reveal>
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed" style={{ color: 'var(--lp-text-muted)' }}>
            TuberMed не поставя диагнози и не решава вместо вас. Изготвя чернова — вие я
            четете, променяте всичко, което поискате, и нищо не напуска екрана без вашето
            одобрение. Инструментът подпомага; клиничното решение остава ваше.
          </p>
        </Reveal>
